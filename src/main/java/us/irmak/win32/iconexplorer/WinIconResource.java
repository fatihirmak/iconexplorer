...
public class WinIconResource extends IconResource implements Closeable {
	...
	public WinIconResource(File file) throws FileNotFoundException {
		super(file);
	...
	private IconGroup createIconGroup(short resourceName) {
		...
		return new WinIconGroup(resourceName, grpdir);
	}
